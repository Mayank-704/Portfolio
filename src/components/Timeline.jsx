...
export const Timeline = ({ data }) => {
  ...
  return (
    <div className="c-space my-20" ref={containerRef}>
      ...
      <div ref={ref} className="relative">
        {data.map((item, index) => (
          ...
          >
            <div className="flex flex-col items-center self-start max-w-xs md:flex-row md:sticky md:top-40 lg:max-w-sm md:w-full z-40">
